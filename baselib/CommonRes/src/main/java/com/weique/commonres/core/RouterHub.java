 ...
 */
package com.weique.commonres.core;
...
public interface RouterHub {
     ...
     * 通用 业务 列表 界面
     */
    String APP_COMMON_BUSINESS_LIST = APP + "/CommonBusinessListActivity";
    String APP_TESTMULITACITVITY = APP + "/TestMulitAcitvity";
    /**
     * 登录页
     */
    String APP_LOGIN_ACTIVITY = APP + "/LoginActivity";
    /**
     * 主界面
     */
     ...
     * 签到界面
     */
    String APP_SIGNIN_ACTIVITY = APP + "/SigninActivity";


    /**
     * 通用动态界面 Activity 有刷新
     */
    String DYNAMIC_COMMON_REFRESH_ACTIVITY = DYNAMIC + "/CommonRefreshActivity";

    /**
     * 通用多布局 activity
     */
    String DYNAMIC_COMMON_MULTIPLE_ACTIVITY = DYNAMIC + "/CommonMultipleActivity";


    /**
     * 通用没有刷新的 activity
     */
    String APP_COMMON_ACTIVITY = APP + "/CommonActivity";
}
